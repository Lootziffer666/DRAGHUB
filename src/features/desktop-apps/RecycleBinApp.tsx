...
export function RecycleBinApp() {
  ...
  const onEmpty = async () => {
    ...
    if (
      ...
      return;
    // Unified empty: clears BOTH kernel recycle-bin entries (discarded drafts
    // from closed windows) and domain-retention entries (retained changes) per
    // repo. Staged deletions are intentionally preserved.
