...
export function PullsButton(){const {open}=usePulls(); return <button onClick={open} className="rounded border border-[var(--dh-window-border)] px-2 py-1 text-xs text-[var(--dh-text-secondary)] hover:border-[var(--dh-window-border-active)] hover:text-white">PRs</button>}
